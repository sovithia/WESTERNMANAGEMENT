            ...
            request.BeginGetResponse((IAsyncResult ar) =>
            {
                ...
                catch (Exception ex)
                {
                    MainThread.BeginInvokeOnMainThread(() => {
                        ...
                        Application.Current.MainPage.DisplayAlert("ERROR", "error happened GET(" + url + ") (" + ex.Message + ")", "OK");
            ...
            request.BeginGetRequestStream((IAsyncResult ar) =>
            {
                try
                {
                    ...
                    request.BeginGetResponse((IAsyncResult ar2) =>
                    {
                        ...
                        {
                            MainThread.BeginInvokeOnMainThread(() => {
                                Application.Current.MainPage.DisplayAlert("ERROR", "error happened POST(" + url + ") (" + ex.Message + ")", "OK");
                                if (returnNullOnError)
                                    del(null);
                            });
                        }
            ...
            request.BeginGetRequestStream((IAsyncResult ar) =>
            {
                try
                {
                    ...
                    request.BeginGetResponse((IAsyncResult ar2) =>
                    {
                        ...
                        {
                            MainThread.BeginInvokeOnMainThread(() => {
                                Application.Current.MainPage.DisplayAlert("ERROR", "error happened PUT(" + url + ") (" + ex.Message + ")", "OK");
                                if (returnNullOnError)
                                    del(null);
                            });
                            return;
            ...
            request.BeginGetRequestStream((IAsyncResult ar) =>
            {
                try
                {
                    ...
                    request.BeginGetResponse((IAsyncResult ar2) =>
                    {
                        ...
                        {
                            MainThread.BeginInvokeOnMainThread(() => {
                                Application.Current.MainPage.DisplayAlert("ERROR", "error happened DELETE(" + url + ") (" + ex.Message + ")", "OK");
                                if (returnNullOnError)
                                    del(null);
                            });
                            return;
